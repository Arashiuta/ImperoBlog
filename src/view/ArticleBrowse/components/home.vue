...
import BrowserSide from "@/view/ArticleBrowse/components/browserSide.vue";
import BrowserBottom from "@/view/ArticleBrowse/components/browserBottom.vue";
import Loading2 from "@/components/loading/loading2.vue";
const browserComment = defineAsyncComponent(
  () => import("@/view/ArticleBrowse/components/comments/browserComments.vue")
);
