...
//顶部展示的图片背景和正在看的用户的信息
//请求对应用户的信息
const res = await UserApi.getUserInfo(routeAccount);
...
.userfocus-container {
  ...
  .listBox {
    ...
    border-radius: 0.5rem;
    border: 0.1rem solid var(--gray-light-border);
    overflow: hidden;
    ...
    .titleList {
      width: 13.5rem;
      min-width: 10rem;
      border-right: 0.1rem solid var(--gray-light-border);

      .focus {
        width: 100%;
        border-bottom: 0.15rem solid var(--gray-light-border);
